...
const BLOG = {
  AUTHOR: 'fyj888', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://fyj.2288666.xyz', // 网站地址
  KEYWORDS: '翻译君,汉化,游戏,博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '6fbde14a9afa4d39b54579e66154c41a', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'sh2288/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  COMMENT_GISCUS_REPO_ID: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO_ID || 'R_kgDOIWRsoA', // 你的Github Repo ID e.g ( 設定完 giscus 即可看到 )
  COMMENT_GISCUS_CATEGORY_ID:
    process.env.NEXT_PUBLIC_COMMENT_GISCUS_CATEGORY_ID || 'DIC_kwDOIWRsoM4CSUtY', // 你的Github Discussions 內的 Category ID ( 設定完 giscus 即可看到 )
